...
public class LocalizationValidationTests
{
    ...
    private static readonly HashSet<string> InvariantOrDeferredResourceKeys = new(StringComparer.Ordinal)
    {
        ...
        // LocalInferencePage (local llama.cpp inference) — seeded English-only
        // across all 5 locales using the deferred-translation pattern, same
        // precedent as the ConfigPage / SessionsPage / CronPage runtime keys
        // above. Several take format placeholders: {0} is a size, a model name,
        // or a port depending on the key.
        "LocalInferencePage_PageTitle.Text",
        "LocalInferencePage_PageDescription.Text",
        "LocalInferencePage_HardwareHeader.Text",
        "LocalInferencePage_RedetectButtonText.Text",
        "LocalInferencePage_ModelHeader.Text",
        "LocalInferencePage_ModelCombo.Header",
        "LocalInferencePage_DownloadButtonText.Text",
        "LocalInferencePage_CancelDownloadButtonText.Text",
        "LocalInferencePage_DeleteModelButtonText.Text",
        "LocalInferencePage_ServerHeader.Text",
        "LocalInferencePage_EnabledToggle.Header",
        "LocalInferencePage_StartButtonText.Text",
        "LocalInferencePage_StopButtonText.Text",
        "LocalInferencePage_EndpointLabel.Text",
        "LocalInferencePage_CopyEndpointButtonText.Text",
        "LocalInferencePage_AdvancedHeader.Text",
        "LocalInferencePage_BackendCombo.Header",
        "LocalInferencePage_CustomRuntimeBox.Header",
        "LocalInferencePage_CustomRuntimeBox.PlaceholderText",
        "LocalInferencePage_CustomRuntimeNoticeText.Text",
        "LocalInferencePage_AutoStartCheck.Content",
        "LocalInferencePage_RegisterCheck.Content",
        "LocalInferencePage_BindBeyondLoopbackCheck.Content",
        "LocalInferencePage_BindBeyondLoopbackHelp.Text",
        "LocalInferencePage_HardwareUnavailable",
        "LocalInferencePage_HardwareDetecting",
        "LocalInferencePage_HardwareRam",
        "LocalInferencePage_HardwareNoGpu",
        "LocalInferencePage_BackendAutomatic",
        "LocalInferencePage_ModelUnavailableSuffix",
        "LocalInferencePage_ModelReady",
        "LocalInferencePage_ModelNotDownloaded",
        "LocalInferencePage_ModelPartial",
        "LocalInferencePage_LargeDownloadNotice",
        "LocalInferencePage_StatusPreparing",
        "LocalInferencePage_StatusRuntimePct",
        "LocalInferencePage_StatusModelPct",
        "LocalInferencePage_StatusDownloadCanceled",
        "LocalInferencePage_StatusDownloadError",
        "LocalInferencePage_ServerStopped",
        "LocalInferencePage_ServerStarting",
        "LocalInferencePage_ServerReady",
        "LocalInferencePage_ServerFailed",
        "LocalInferencePage_ConfirmDownloadTitle",
        "LocalInferencePage_ConfirmDownloadBody",
        "LocalInferencePage_ConfirmDownloadPrimary",
        "LocalInferencePage_ConfirmDownloadCancel",
        "LocalInferencePage_ConfirmDeleteTitle",
        "LocalInferencePage_ConfirmDeleteBody",
        "LocalInferencePage_ConfirmDeletePrimary",
        "LocalInferencePage_ConfirmCancelButtonText.Text",
        "LocalInferencePage_StatusDeleteError",
